...
var tb_pathToImage = "/files/js/thickbox/images/loadingAnimation.gif";
...
//							TB_imageCount = "Image " + (TB_Counter + 1) +" of "+ (TB_TempArray.length);
			...
			$("#TB_window").append("<a href='' id='TB_ImageOff' title='X'><img id='TB_Image' src='"+url+"' width='"+imageWidth+"' height='"+imageHeight+"' alt='"+caption+"'/></a>" + "<div id='TB_caption'>"+caption+"<div id='TB_secondLine'>" + TB_imageCount + TB_PrevHTML + TB_NextHTML + "</div></div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton' title='Close'>close</a> or Esc Key</div>");
