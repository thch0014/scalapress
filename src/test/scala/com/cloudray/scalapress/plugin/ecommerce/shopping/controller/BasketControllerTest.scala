...
import com.cloudray.scalapress.plugin.ecommerce.variations.{Variation, DimensionValue, Dimension, VariationDao}
import com.cloudray.scalapress.plugin.ecommerce.shopping.domain.{BasketLine, Basket}
